...
parser.add_argument('-e', '--epochs', type=int, required=False, help='Number of epochs to train AE model [Default=100]', default=1000)
...
#train(traj=traj, top=top, out=out, fname=f_name, epochs=epochs, lat=lat, batchSize=batchSize)
